...
// ⚡ Bolt Optimization: Memoize the voice list to prevent re-renders on text input
const VoiceList = memo(({ groupedVoices, selectedVoiceId, onSelect }: VoiceListProps) => {
  return (
