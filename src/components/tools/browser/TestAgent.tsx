...
export default function TestAgent() {
  ...
  // OPTIMIZATION: Expensive data transformation memoized to run only when result changes
...
// OPTIMIZATION: Moved outside component to prevent re-allocation on every render
const RESOURCE_COLORS = ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#6366f1'];

// OPTIMIZATION: Extracted component to prevent unmount/remount on parent render
const CustomTooltip = ({
  active,
  payload,
  label,
